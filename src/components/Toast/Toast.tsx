...
const Toast = ({ toast, setToast }: Props) => {
  ...
  const btn =
    toast?.type === 'error'
      ...
      : `focus:ring-offset-gray-800 focus:ring-gray-500 dark:focus:ring-offset-gray-500 dark:focus:ring-gray-700`;
            ...
            <div className='flex p-4'>
              ...
              <div className='ml-auto'>
                <button
                  ...
                  className={`ml-2 inline-flex flex-shrink-0 justify-center items-center h-4 w-4 rounded-md text-white/[.5] hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all text-sm ${btn}}`}
                >
